...
# Mini diff from https://github.com/newrelic/k8s-webhook-cert-manager. 99% of the code is in that repo. Thanks!
...
echo "$(cat /run/secrets/kubernetes.io/serviceaccount/ca.crt)" >> "${tmpdir}/server-cert.pem"
